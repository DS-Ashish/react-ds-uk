  ...
  return (
    <>
     <section id="hero" className="hero hero-1">
      ...
      <section id="services" className="services hero-1 hero ovr-f">
        <div className="container" data-aos="fade-up">
           <header className="section-header">
              <h3>Ready to chat?
              </h3>
              <p>See How Dynamics Square Can Help Transform Your Business
                With Microsoft Business Applications.</p>
           </header>
